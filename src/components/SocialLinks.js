...
const SocialLinks = () => {
  const links = [
    {
      id: 1,
      href: "https://www.linkedin.com/in/bikash-tripathy-512610220/",
      child: (
        <>
    ...
    {
      id: 2,
      href: "https://github.com/bikash12tri",
      child: (
        <>
    ...
    {
      id: 3,
      href: "mailto:bikashtripathy646@gmail.com",
      child: (
        <>
...
//https://api.whatsapp.com/send?phone=919909779216&text=Hello%F0%9F%98%80
  return (
